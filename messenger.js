...
(function(d) {
    ...
    c.b = function(a, c, d) {
        ...
        return new Promise(function(a, c) {
            ...
            f ? (Object(l.a)().newMessage(Object(l.a)().botWriting()), e.send(JSON.stringify(f)), Object(k.d)(d, m.W, {
                requestBody: f
            })) : (h = Object.assign({}, t.b), h.error.message = "Please specify query input (text or event)", b(h), c(h));
    ...
    a.prototype.rendererForTesting = function(a, b) {
        var c = new h.a;
        "text" === a ? c.constructTextResponse_(b, Object(e.a)()) : ("chips" === a ? c = c.constructChipsPayload_(b) : (b.type = a, a = c.constructItemPayload(b), c = c.constructCustomCard_([a])), Object(e.a)().newMessage(c))
    };
        ...
        function m() {
            ...
            var p = function(a) {
                ...
                C = function(a) {
                    ...
                    U && 3 === a.nodeType && (d = a.textContent, d = O(d, Ia, " "), d = O(d, Ka, " "), a.textContent !== d && (J(b.removed, {
                        element: a.cloneNode()
                    }), a.textContent = d));
    ...
    d.prototype.setTextAndLink_ = function() {
        ...
        this.link ?
            a.href = this.link : (a.removeAttribute("href"), a.removeAttribute("target"));
    ...
    a.prototype.onError = function(a, b, c) {
        a && a.parentNode && a.parentNode.host && (b = a.parentNode.host, c = b.tagName, Object(f.g)(a), b && c === e.t.toUpperCase() && Object(f.g)(b))
    };
    ...
    d.prototype.renderChips_ = function() {
        this.shadowRoot.appendChild(this.chips.map(function(a) {
            ...
            b && b.src && b.src.rawUrl && (b = Object(e.c)("img",
                [], null, {
                    src: b.src.rawUrl
